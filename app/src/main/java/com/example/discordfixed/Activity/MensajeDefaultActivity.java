...
public class MensajeDefaultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fotoperfil = (CircleImageView)findViewById(R.id.fotoPerfil_grupal);
        nombre = (TextView)findViewById(R.id.nombre_grupal);
        rvMensajes = (RecyclerView)findViewById(R.id.rvMensajes_grupal);
        txtMensajes = (EditText)findViewById(R.id.txtMensaje_grupal);
        btnEnviar = (Button)findViewById(R.id.btnEnviar_grupal);
        cerrarSesion = (ImageButton)findViewById(R.id.cerrarSesion_grupal);
        btnEnviarFoto = (ImageButton)findViewById(R.id.btnEnviarFoto_grupal);
        fotoPerfilCadena = "";
        menuOpciones = (Spinner)findViewById(R.id.spmenuOpciones_grupal);
        ...
        databaseReference = database.getReference("chatv3"); //Sala de chat

        storage = FirebaseStorage.getInstance();
        mAuth = FirebaseAuth.getInstance();

        String [] opc_menu = {"Cambiar foto de perfil", "Crear chat privado", "Banearlos a todos", "Cerrar Sesión"};
        ...
        menuOpciones.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view,
                ...
                if(item.toString().equals("Crear chat privado")){
                    startActivity(new Intent(MensajeDefaultActivity.this,VerUsuariosActivity.class));
                }
            }
        ...
        if(currentUser!=null)
        {
            ...
            reference.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    NOMBRE_USUARIO = "Chat pricipal";
                    nombre.setText(NOMBRE_USUARIO);
                    Glide.with(MensajeDefaultActivity.this).load(usuario.getFotoPerfilURL()).into(fotoperfil);
                }
    ...
    private void returnLogin(){
        startActivity(new Intent(MensajeDefaultActivity.this, LoginActivity.class));
        finish();
    }
}
